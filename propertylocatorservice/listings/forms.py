...
#    class Meta:
#        model = Listing
#        fields = ['title', 'description', 'area', 'borough', 'listing_type', 'property_status', 'price', 'rental_frequency', 'rooms', 'furnished', 'elevator', 'pool', 'cctv', 'parking','date_posted','location',
